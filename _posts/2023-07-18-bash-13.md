---
layout: post
title:  "Fer un script que rebi per paràmetre el nom d’un fitxer, verifiqui si existeix i que és un fitxer comú (permisos de lectura i escriptura) i el converteixi en executable per l’usuari i el grup i mostri l’estat final dels permisos"
categories: bash
author: aleon
date: 2023-07-18 15:33:00 +0200
---
```bash
#!/bin/bash
#Aleix Leon
