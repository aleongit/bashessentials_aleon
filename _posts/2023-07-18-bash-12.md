---
layout: post
title:  "Comprovar si el directori passat per paràmetre ja existeix; si existeix que mostri un missatge. Si no existeix l’haurà de crear i dir que l’ha creat"
categories: bash
author: aleon
date: 2023-07-18 15:30:00 +0200
---
```bash
#!/bin/bash
#Aleix Leon
