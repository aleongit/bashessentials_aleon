---
layout: post
title:  "Fer un script que permeti introduir per paràmetre el nom d’una carpeta. Si existeix aquesta carpeta comprimida (amb extensió .tar.gz), borreu-la i si no existeix, comprimir la carpeta"
categories: bash
author: aleon
date: 2023-06-30 13:50:00 +0200
---
```bash
#!/bin/bash
#Aleix Leon
